...
la.prototype.get=function(){if(0<this.b){this.b--;var a=this.a;this.a=a.next;a.next=null}else a=this.f();return a};function ma(a){var b=A,c;for(c in b)if(a.call(void 0,b[c],c,b))return c}
...
function S(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{a=a||window.event;if(!a)return;this.a=a}catch(c){a={};if(("EXPERIMENT_FLAGS"in R?R.EXPERIMENT_FLAGS:a).kevlar_js_fixes)return;throw c;}for(var b in a)b in Xa||(this[b]=a[b]);(b=a.target||a.srcElement)&&3==b.nodeType&&(b=b.parentNode);
...
S.prototype.stopImmediatePropagation=function(){this.a&&(this.a.cancelBubble=!0,this.a.stopImmediatePropagation&&this.a.stopImmediatePropagation())};var A=n("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",A);var Ya=n("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",Ya);
...
(f||g)})}
function $a(a){a&&("string"==typeof a&&(a=[a]),z(a,function(b){if(b in A){var c=A[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?ab()||"boolean"==typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete A[b]}}))}
...
g=Ua(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),ab()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);A[e]=[a,b,c,g,d]}}}
...
k.destroy=function(){this.a.id&&(T[this.a.id]=null);var a=this.g;a&&"function"==typeof a.dispose&&a.dispose();if(this.i){a=this.a;var b=a.parentNode;b&&b.replaceChild(this.i,a)}else(a=this.a)&&a.parentNode&&a.parentNode.removeChild(a);V&&(V[this.h]=null);this.b=null;a=this.a;for(var c in A)A[c][0]==a&&$a(c);this.i=this.a=null};
k.v=function(){return{}};
...
window.postMessage?1:0;window.location.host&&(h.origin=window.location.protocol+"//"+window.location.host);h.widgetid=a.h;window.location.href&&z(["debugjs","debugcss"],function(p){var u=window.location.href;var da=u.search(Sa);b:{var r=0;for(var B=p.length;0<=(r=u.indexOf(p,r))&&r<da;){var C=u.charCodeAt(r-1);if(38==C||63==C)if(C=u.charCodeAt(r+B),!C||61==C||38==C||35==C)break b;r+=B+1}r=-1}if(0>r)u=null;else{B=u.indexOf("&",r);if(0>B||B>da)B=da;r+=p.length+1;u=decodeURIComponent(u.substr(r,B-r).replace(/\+/g,
" "))}null===u||(h[p]=u)});
