! function(e, t) {
    ...
    var p, l = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
                    ...
                    if (!o("json")) {
                                ...
                                N = function(e, t, n, r, o, i, s) {
                                    ...
                                    if ("object" == typeof a) {
                                        ...
                                        if (s.push(a), S = [], j = i, i += o, "[object Array]" == u) {
                                            for (T = 0, x = a.length; T < x; T++) A = N(T, a, n, r, o, i, s), S.push(A === v ? "null" : A);
                                            k = S.length ? o ? "[\n" + i + S.join(",\n" + i) + "\n" + j + "]" : "[" + S.join(",") + "]" : "[]"
                        ...
                        if (!o("json-parse")) {
                            var A, T, x = a.fromCharCode,
                                ...
                                R = function() {
                                    for (var e, t, n, r, o, i = T, s = i.length; A < s;) switch (o = i.charCodeAt(A)) {
                                        case 9:
                                        case 10:
                                        case 13:
                                        case 32:
                                        ...
                                        case 34:
                                            for (e = "@", A++; A < s;)
                                                if ((o = i.charCodeAt(A)) < 32) k();
                                                    ...
                                                    case 114:
                                                        ...
                                                        break;
                                                    case 117:
                                                        for (t = ++A, n = A + 4; A < n; A++)(o = i.charCodeAt(A)) >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || k();
                                                        e += x("0x" + i.slice(t, A));
                                                        break;
                                                    default:
                                                        k()
                                            ...
                                            k();
                                        default:
                                            if (t = A, 45 == o && (r = !0, o = i.charCodeAt(++A)), o >= 48 && o <= 57) {
                                                for (48 == o && (o = i.charCodeAt(A + 1)) >= 48 && o <= 57 && k(), r = !1; A < s && (o = i.charCodeAt(A)) >= 48 && o <= 57; A++);
        ...
        U = function e(t, n) {
            var r = A(n);
            if (-1 !== F.indexOf(r)) j.warn('WARNING: Property key "' + t + '" with invalid value type ' + r + ", ignoring"), n = null;
            else if ("error" === r) n = String(n), j.warn('WARNING: Property key "' + t + '" with value type error, coercing to ' + n);
            else if ("array" === r) {
                for (var o = [], i = 0; i < n.length; i++) {
                    var s = n[i],
                        a = A(s);
                    "array" !== a && "object" !== a ? o.push(e(t, s)) : j.warn("WARNING: Cannot have " + a + " nested in an array property value, skipping")
                }
                n = o
            } else "object" === r && (n = P(n));
            return n
    ...
    Y.prototype._cookiesEnabled = function() {
        ...
        if (this._cookiesEnabled()) this.storage = z;
        else {
            this.storage = {
                _options: {
                    expirationDays: void 0,
    ...
    var X = e(function(e) {
                ...
                function h(e, t) {
                    return function(e, t) {
                        var n, r, o = p(e),
                            i = [],
                            s = [];
                        for (i[15] = s[15] = void 0, o.length > 16 && (o = u(o, 8 * e.length)), n = 0; n < 16; n += 1) i[n] = 909522486 ^ o[n], s[n] = 1549556828 ^ o[n];
        ...
        et = /^(?:0|[1-9]\d*)$/,
        tt = function(e, t) {
            return !!(t = null == t ? Ze : t) && ("number" == typeof e || et.test(e)) && e > -1 && e % 1 == 0 && e < t
        },
        nt = function(e, t, n) {
            if (!de(n)) return !1;
            var r = typeof t;
        ...
        rt = function(e) {
            return Ye(function(t, n) {
                var r = -1,
                    ...
                    i = o > 1 ? n[o - 1] : void 0,
                    s = o > 2 ? n[2] : void 0;
                for (i = e.length > 3 && "function" == typeof i ? (o--, i) : void 0, s && nt(n[0], n[1], s) && (i = o < 3 ? void 0 : i, o = 1), t = Object(t); ++r < o;) {
                    var a = n[r];
                    a && e(t, a, r, i)
                }
                return t
    ...
    qt.prototype.sendEvents = function(e) {
        if (!this._apiKeySet("sendEvents()") || this._sending || this.options.optOut || 0 === this._unsentCount()) "function" === A(e) && e(0, "No request sent");
            ...
            var t = (this.options.forceHttps ? "https" : "https:" === window.location.protocol ? "https" : "http") + "://" + this.options.apiEndpoint + "/",
                ...
                c = this;
            new Pt(t, u).send(function(t, r) {
                c._sending = !1;
                try {
                    200 === t && "success" === r ? (c.removeEvents(o, i), c.options.saveEvents && c.saveEvents(), c._sendEventsIfReady(e) || "function" !== A(e) || e(t, r)) : 413 === t ? (1 === c.options.uploadBatchSize && c.removeEvents(o, i), c.options.uploadBatchSize = Math.ceil(n / 2), c.sendEvents(e)) : "function" === A(e) && e(t, r)
                } catch (e) {}
            })
        }
    ...
    }, qt.prototype.__VERSION__ = "4.2.1";
    var Yt = function() {
    ...
    Yt.prototype.Identify = Q, Yt.prototype.Revenue = Ft, Yt.prototype.getInstance = function(e) {
        ...
        this.getInstance().setUserProperties(e)
    }, Yt.prototype.__VERSION__ = "4.2.1";
