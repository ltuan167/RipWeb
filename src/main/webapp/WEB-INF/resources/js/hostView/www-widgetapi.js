(function() {
    ...
    function S(a) {
        ...
        try {
            ...
            a = {};
            if (("EXPERIMENT_FLAGS" in R ? R.EXPERIMENT_FLAGS : a).kevlar_js_fixes) return;
            throw c;
        }
    ...
    var A = n("ytEventsEventsListeners") || {};
    x("ytEventsEventsListeners", A);
    ...
    function mb(a, b) {
        ...
        window.location.href && z(["debugjs", "debugcss"], function(p) {
            ...
            b: {
                var r = 0;
                for (var B = p.length; 0 <= (r = u.indexOf(p, r)) && r < da;) {
                    var C = u.charCodeAt(r - 1);
                    if (38 == C || 63 == C)
                        if (C = u.charCodeAt(r + B), !C || 61 == C || 38 == C || 35 == C) break b;
                    r += B + 1
                }
                r = -1
            }
            if (0 > r) u = null;
                ...
                if (0 > B || B > da) B = da;
                r += p.length + 1;
                u = decodeURIComponent(u.substr(r, B - r).replace(/\+/g,
                    " "))
            }
            null === u || (h[p] = u)
        });
