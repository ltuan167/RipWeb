...
<!DOCTYPE html>
<html class="home page-template page-template-page--component-template page-template-page--component-template-php page page-id-3889 background-type--pattern canvas canvastext csscalc svgclippaths flexbox flexboxlegacy no-flexboxtweener fixedsticky-withoutfixedfixed velocity no-touch kahooter has-cookie-msg canvas canvastext csscalc svgclippaths flexbox flexboxlegacy no-flexboxtweener canvas canvastext csscalc svgclippaths flexbox flexboxlegacy no-flexboxtweener canvas canvastext csscalc svgclippaths flexbox flexboxlegacy no-flexboxtweener nav-fixed" data-theme="purple" lang="en">
...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="https://kahoot.com/wp-content/themes/kahoot2017/assets/cssv/screen-ac4ffd37aa.css">
    </noscript><%--
    ...
    <script>
        ...
        (function(a){if(!a.loadCSS){a.loadCSS=function(){}}var b=loadCSS.relpreload={};b.support=(function(){var d;try{d=a.document.createElement("link").relList.supports("preload")}catch(f){d=false}return function(){return d}})();b.bindMediaToggle=function(e){var f=e.media||"all";function d(){if(e.addEventListener){e.removeEventListener("load",d)}else{if(e.attachEvent){e.detachEvent("onload",d)}}e.setAttribute("onload",null);e.media=f}if(e.addEventListener){e.addEventListener("load",d)}else{if(e.attachEvent){e.attachEvent("onload",d)}}setTimeout(function(){e.rel="stylesheet";e.media="only x"});setTimeout(d,3000)};b.poly=function(){if(b.support()){return}var d=a.document.getElementsByTagName("link");for(var e=0;e
        <d.length;e++){var f=d[e];if(f.rel==="preload"&&f.getAttribute("as")==="style"&&!f.getAttribute("data-loadcss")){f.setAttribute("data-loadcss",true);b.bindMediaToggle(f)}}};if(!b.support()){b.poly();var c=a.setInterval(b.poly,500);if(a.addEventListener){a.addEventListener("load",function(){b.poly();a.clearInterval(c)})}else{if(a.attachEvent){a.attachEvent("onload",function(){b.poly();a.clearInterval(c)})}}}if(typeof exports!=="undefined"){exports.loadCSS=loadCSS}else{a.loadCSS=loadCSS}}(typeof global!=="undefined"?global:this));
    ...
    <header class="page-header" role="banner" itemscope="" itemtype="http://schema.org/WPHeader">
        <div class="page-header__inner">
            ...
            <a title="Link to ripweb.com homepage" aria-label="Link to ripweb.com homepage" class="logo-link" href="#">
                ...
                <svg width="146" height="50" viewBox="0 0 88 30" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" class="kahoot-logo">
                    <title>RipWeb!</title>
            ...
            <nav class="header-menu" aria-label="Navigation" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                <div class="menu-header-menu-container">
                    <ul id="menu-header-menu" class="">
                        <li id="menu-item-104" class="mobile-hide menu-item menu-item-type-post_type menu-item-object-page menu-item-102">
                            <a data-tracking-id="explore-games-top-bar" itemprop="url" href="host">
                                <strong>Create Game</strong>
                            </a>
                        </li>
                        <li id="menu-item-102" class="mobile-hide menu-item menu-item-type-post_type menu-item-object-page menu-item-102">
                            <a data-tracking-id="explore-games-top-bar" itemprop="url" href="#aboutUs">About Us</a>
                        </li>
                        <li id="menu-item-34" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-34">
                            <a target="_self" data-tracking-id="play-top-bar" itemprop="url" href="play">Enter game PIN!</a>
                        </li>
                        <li id="menu-item-35" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-35">
                            <a target="_self" data-tracking-id="sign-in-top-bar" itemprop="url" href="login">Log in</a>
                        </li>
                        <li id="menu-item-36" class="btn-wrap menu-item menu-item-type-custom menu-item-object-custom menu-item-36">
                            <a target="_self" data-tracking-id="sign-up-top-bar" itemprop="url" href="signup">Sign up</a>
                        </li>
                        <li id="menu-item-6515" class="mobile-hide nav-icon nav-icon--help menu-item menu-item-type-custom menu-item-object-custom menu-item-6515">
                            <a target="_self" href="https://support.ripweb.com/" itemprop="url">
        ...
        <div class="inner">
            <div class="menu-main-navigation-container">
                <ul id="menu-main-navigation" class="">
                    <li id="menu-item-3426" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3426">
...
<main id="main" class="page">
    <section class="page-section">
        ...
        <div class="anchor-wrap">
            <a name="for-teachers" class="page-anchor"></a>
        </div>
    </section>
    <!-- /close section -->
    <!-- ++ open env + + -->
    <section class="page-section envelope-section" id="aboutUs">
        <div class="env-section">
            <!-- + + open env + + -->
            <div class="env-section__top ">
                <div class="inner ">
                    <h1 class="hero-title">About Us</h1>
                    <p>'We' is powerful. We believe in 'We', when you talk to us, you are the businessman, user's advocate and industry insider. When you and us come together progress, discoveries and inventions happen.</p>
                </div>
            </div>
            <div class="env-section__body">
                                            ...
                                            <div class="card-component__body card-component__body--tag">
                                                <div class="author-meta">
                                                    ...
                                                    <div class="author-meta__info">
                                                        <a class="author-meta__name" id="author-post-id-7707" href="https://www.facebook.com/tranduckhoatcu">
                                                            <span class="visually-hidden">Author:</span>Khoa Tran, Tcu
                                                        </a>
                                                ...
                                                <div class="card-component__snippet">
                                                    <h1 itemprop="headline" id="post-id-7707">
                                                        <a title="Front-end Developer">Front-end Developer</a>
                                                    </h1>
                                                    <p itemprop="description">Have a good day
                                                        <3
                                                    </p>
                                                </div>
                                                <div class="skew-wrap">
                                                    <div class="card-component__hashtag skew">
                                                        <div class="skew__inner" itemprop="keywords">
                                                            <a href="https://www.facebook.com/tranduckhoatcu" rel="tag">Learn More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--blog-component__body -->
                                        </article>
                                    </div>
                                    <!-- //layout__item -->
                                    <div class="layout__item" style="opacity: 1; display: flex; transform: scaleX(1) scaleY(1);">
                                        <article class="card-component  component-theme--green" itemscope="" itemprop="blogPost" itemtype="http://schema.org/BlogPosting">
                                            ...
                                            <div class="card-component__body card-component__body--tag">
                                                <div class="author-meta">
                                                    ...
                                                    <div class="author-meta__info">
                                                        <a class="author-meta__name" id="author-post-id-7649" href="https://www.facebook.com/l.etu.an20320">
                                                            <span class="visually-hidden">Author:</span>Le Tuan, Lee
                                                        </a>
                                                ...
                                                <div class="card-component__snippet">
                                                    <h1 itemprop="headline" id="post-id-7649">
                                                        <a title="Back-end Developer">Back-end Developer</a>
                                                    </h1>
                                                ...
                                                <div class="skew-wrap">
                                                    <div class="card-component__hashtag skew">
                                                        <div class="skew__inner" itemprop="keywords">
                                                            <a href="https://www.facebook.com/l.etu.an20320" rel="tag">Learn More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <article class="card-component  component-theme--red" itemscope="" itemprop="blogPost" itemtype="http://schema.org/BlogPosting">
                                            ...
                                            <div class="card-component__body card-component__body--tag">
                                                <div class="author-meta">
                                                    ...
                                                    <div class="author-meta__info">
                                                        <a class="author-meta__name" id="author-post-id-7637" href="https://www.facebook.com/hungthuanmk">
                                                            <span class="visually-hidden">Author:</span>Nguyen Phan Hung Thuan
                                                        </a>
                                                ...
                                                <div class="card-component__snippet">
                                                    <h1 itemprop="headline" id="post-id-7637">
                                                        <a title="Back-end Developer">Back-end Developer</a>
                                                    </h1>
                                                    <p itemprop="description">Technology fan having a big dream
                                                        <3
                                                    </p>
                                                </div>
                                                <div class="skew-wrap">
                                                    <div class="card-component__hashtag skew">
                                                        <div class="skew__inner" itemprop="keywords">
                                                            <a href="https://www.facebook.com/hungthuanmk" rel="tag">Learn More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="page-break">
                    <div class="outer">
                        <div class="inner">
                            <svg width="864px" height="57px" viewBox="0 0 864 57" version="1.1"
    ...
    <!-- ++ open env + + -->
    <section class="page-section envelope-section in-view">
        <div class="env-section">
            <!-- + + open env + + -->
            <div class="env-section__top ">
                <div class="inner ">
                            ...
                            <article class="text-image-article">
                                <div class="text-image">
                                    <div class="text-image__text">
                                        <h1></h1>
                                        <p>
                                            <strong>RipWeb!</strong>
                                        </p>
                                        <p>International University - HCMIU-VNU</p>
                                        <p>
                                            <a class="btn theme-opposite" data-tracking-id="free-trial-welcomeback" target="_self" href="signup">Signup now</a>
                                        </p>
                                    </div>
            ...
            <nav class="footer-nav footer-nav--inline" role="navigation" aria-label="Follow us Navigation" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
                ...
                <div class="footer-nav__menu">
                    <ul id="menu-follow-us" class="">
                        <li id="menu-item-86" class="social-facebook menu-item menu-item-type-custom menu-item-object-custom menu-item-86">
                            <a target="_blank" href="https://www.facebook.com/hcmiuiot/?__tn__=kCH-R&eid=ARCLgKWuaUNNh0ov6-tdLCCJdUtJLUO31Q6z39mMbe9iSG9J_u6R2hUHF1YFGGLgXG0RjiFwpYDmFOhN&hc_ref=ARRKAm8j-Mxxat-GAKIJDMWeTjRvjZH3o-9mpVwZ3EMS0H0KRpLk3cEA04SeMC129r8&fref=nf&__xts__[0]=68.ARDhw4nciP7kSuwZR3WqhlNmxs7KSZlnzoQ2V2krAoc72wQacm887LjosfjGgQbw1Nm6eaWSM-lYHWOby0jRMdaxIhb4WASJ4ydfa_aXs4IKGvrdCTdatN16jh3jtpkW_ITICzHyVcK1NIO-y2KG0nPQblI0SNeNP8U4ZLFzA4YALiEY6NsJ5KyhoqNcXctHdGCQW8JsUjS6WTtv0Isk-n4LJasPykWkOWmz5MStVd3gjowYSnxC7BmUofQhtF2799_Wb9dLCJgZTYmeSitbmJ4tr5yPnpRIrWi6DRmyt78IzQalDmz4Gmkrpy6N0eOB6Qafj-x5wyl12E6WDgCJaawd4tza" itemprop="url">Facebook</a>
                        </li>
                        <li id="menu-item-85" class="social-linkedin menu-item menu-item-type-custom menu-item-object-custom menu-item-85">
                            <a target="_blank" href="https://github.com/hcmiuiot" itemprop="url">Github</a>
                        </li>
                        <li id="menu-item-84" class="social-linkedin menu-item menu-item-type-custom menu-item-object-custom menu-item-85">
                            <a target="_blank" href="https://hcmiuiotclub.slack.com/" itemprop="url">Slack</a>
                        </li>
                    </ul>
                </div>
            </nav>
...
<script type="text/javascript" id="">(function(a,d){function c(a,b){a.prototype[b]=function(){this._q.push([b].concat(Array.prototype.slice.call(arguments,0)));return this}}function h(a){function b(b){a[b]=function(){a._q.push([b].concat(Array.prototype.slice.call(arguments,0)))}}for(var c=0;c
<k.length;c++)b(k[c])}var b=a.amplitude||{_q:[],_iq:{}},e=d.createElement("script");e.type="text/javascript";e.async=!0;e.src="resources/js/homepage/amplitude-4.2.1-min.gz.js";e.onload=function(){a.amplitude.runQueuedFunctions?a.amplitude.runQueuedFunctions():
    console.log("[Amplitude] Error: could not load SDK")};var f=d.getElementsByTagName("script")[0];f.parentNode.insertBefore(e,f);e=function(){this._q=[];return this};f="add append clearAll prepend set setOnce unset".split(" ");for(var g=0;g
<f.length;g++)c(e,f[g]);b.Identify=e;e=function(){this._q=[];return this};f=["setProductId","setQuantity","setPrice","setRevenueType","setEventProperties"];for(g=0;g
...
amplitude.getInstance().logEvent("[Website] Pageview",google_tag_manager["GTM-WFBWSXS"].macro(7));
</script>
<script type="text/javascript" id="">$("a").click(function(){var a=$(this).data("tracking-id");void 0!=a&&dataLayer.push({event:"clickTopBar",trackid:a})});
</script>
</body>
</html>