...
<div id="pinScreen">
    <div style="height: 0; width: 0; position: absolute; visibility: hidden">
        <!-- <svg
        xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"><defs><filter x="-2.2%" y="-2.3%" width="104.4%" height="104.8%" filterUnits="objectBoundingBox" id="a"><feOffset dy="1" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset><symbol id="logo-shapes" viewBox="0 0 24 24"><ellipse cx="5.506" cy="18.966" rx="4.953" ry="4.953"></ellipse><path d="M12.005 5.902L17.873.033l5.869 5.869-5.869 5.868zm1.443 8.899h8.849v8.849h-8.849zm-2.584-4.977H.146l5.36-8.555z"></path></symbol></filter></defs></svg> -->
    </div><%--
									<script async="" src="Mainpage_files/analytics.js"></script>--%><%--
									<script type="text/javascript" async="" src="Mainpage_files/amplitude-4.js"></script>--%><%--
									<script src="Mainpage_files/kahunaAPI_min.js"></script>--%><%--
    ...
    <iframe id="gameBlockIframe" style="display:none;" class="game-block-iframe" sandbox="allow-scripts allow-same-origin" scrolling="no"></iframe>
    <!-- ngView: -->
            ...
            <div class="vertical-alignment-wrapper">
                ...
                <div class="vertical-alignment-wrapper__bottom">
                    ...
                    <p class="info ng-binding" ng-show="!isMobileApp &amp;&amp; notStandalone()">        Create your own RipWeb for FREE at
                        ...
                        <a href="/" target="_system" class="ng-binding">          Ahihi :))          </a>
                    </p>
                    <p class="legal-info" ng-show="!isMobileApp">
                        <a href="https://dictionary.cambridge.org/vi/dictionary/english/term" class="legal-info__link ng-binding" target="_system">          Terms        </a>        |
                        <a href="https://dictionary.cambridge.org/vi/dictionary/english/privacy?q=Privacy" class="legal-info__link ng-binding" target="_system">          Privacy        </a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div id="mainView" ng-view="" class="ng-scope">
        <div class="screen instructions-screen ng-scope" ios7lazyfix="">
            <div class="status-bar status-bar--header ng-scope" ng-if="!isTeamMode">
                <div class="status-bar__item status-bar__game-pin ng-binding">      PIN:
                    <a name="pin"></a>
                </div>
                <div class="status-bar__item status-bar__username ng-binding">
                    <a id="nickname"></a>
                </div>
            </div>
            <div class="screen__main instructions" ng-class="{'screen__main--instructions-team-mode': isTeamMode}">
                ...
                <ul class="players__members-list ng-hide" ng-show="isTeamMode"></ul>
            </div>
            <div class="status-bar status-bar--footer ng-scope" ng-if="!isTeamMode">
                <div class="status-bar__item status-bar__username ng-binding" data-functional-selector="cleaned-username"></div>
            </div>
        </div>
    </div>
    <div alerts=""></div>
...
<div id="playScreen">
    ...
    <!-- ngView: -->
    <div id="scoreBar" ng-view="" class="ng-scope" style="height: auto;">
