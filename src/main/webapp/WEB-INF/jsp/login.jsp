...
<div class="text-center d-block register-photo" style="margin: auto;padding: 40px 10px 10px;height: 1080px;width: auto;">
    <div class="form-container">
        ...
        <form method="post" action="login">
            <h2 class="text-center" style="font-size: 60px;margin: 0px 0px 10px;font-family: Allerta, sans-serif;"><strong><em>RIPWEB!</em></strong></h2>
            ...
            <strong style="color: #ff1600"><em>${msg}</em></strong>
