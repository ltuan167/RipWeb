...
<script>
    ...
    if (clientId) {
        ga('create', 'UA-35308575-1', 'auto', {'sampleRate': 1, 'allowLinker': true, 'clientId':gup('gaId', window.location.search)});
    } else {
...
<script type="text/javascript">
    // Helps us work around some ios7 safari bugs
        ...
        <div class="row" style="width: 100%;height: 30%;margin: 0;margin-top: 5px;">
            <div class="col-auto" style="width: 100%;height: 100%;padding-right: 0;padding-left: 0;">
                <div class="row" style="width: 100%;height: 48%;margin-left: 0;margin-right: 0;">
                    ...
                    <div
                            class="col" style="width: 100%;height: 100%;padding-right: 0.05em;padding-left: 0.05em;margin-right: 0.05em;margin-left: 0.05em;"><button id="answer2" class="btn btn-primary btn-lg border-white" type="button" style="width: 100%;height: 100%;padding: 0;padding-right: 0.05em;background-color: #1368ce;padding-left: 0.05em;font-family: Comfortaa, cursive;font-weight: bold;font-size: 2.3em;">Answer 2</button></div>
                </div>
                <div class="row" style="width: 100%;height: 45%;margin-top: 0.1em;margin-right: 0;margin-left: 0;">
                    ...
                    <div
                            class="col" style="width: 100%;height: 100%;padding-right: 0.05em;padding-left: 0.05em;margin-left: 0.05em;"><button id="answer4" class="btn btn-primary btn-lg border-white" type="button" style="width: 100%;height: 100%;padding: 0;background-color: #298f0d;padding-left: 0.05em;padding-right: 0.05em;font-family: Comfortaa, cursive;font-weight: bold;font-size: 2.3em;">Answer 4</button></div>
                </div>
            </div>
        </div>
    </div>
